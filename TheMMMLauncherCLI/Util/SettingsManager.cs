...
namespace TheMMMLauncherCLI.Util
{
    ...
    {
        private static string settingsJsonPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "The MMM Launcher", "settings.json");
